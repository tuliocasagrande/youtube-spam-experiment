...
def exp2(filename):
    ...
    config = [
        ('SVM 0.3', SingleClassification(filename, train_percent=0.3,
         test_percent=0.3)),
        ('SVM 0.4', SingleClassification(filename, train_percent=0.4,
         test_percent=0.3)),
        ('SVM 0.5', SingleClassification(filename, train_percent=0.5,
         test_percent=0.3)),
        ('SVM 0.6', SingleClassification(filename, train_percent=0.6,
         test_percent=0.3)),
    ...
    config = [
        ('SVM 0.3 + SS 0.4', SemiSupervisedClassification(filename,
         threshold=0.9, train_percent=0.3, ss_percent=0.4)),
        ('SVM 0.4 + SS 0.3', SemiSupervisedClassification(filename,
         threshold=0.9, train_percent=0.4, ss_percent=0.3)),
        ('SVM 0.5 + SS 0.2', SemiSupervisedClassification(filename,
         threshold=0.9, train_percent=0.5, ss_percent=0.2)),
        ('SVM 0.6 + SS 0.1', SemiSupervisedClassification(filename,
         threshold=0.9, train_percent=0.6, ss_percent=0.1))]
